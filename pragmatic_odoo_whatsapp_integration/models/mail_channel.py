...
class mailChannel(models.Model):
    ...
    def send_whatsapp_message(self, partner_ids, kwargs, message_id):
        if 'author_id' in kwargs and kwargs.get('author_id'):
            ...
            res_user_id = self.env['res.users'].sudo().search([('partner_id', '=', partner_id.id)])

            no_phone_partners = []
            invalid_whatsapp_number_partner = []
            if res_user_id.whatsapp_endpoint and res_user_id.whatsapp_token:
                status_url = res_user_id.whatsapp_endpoint + '/status?token=' + res_user_id.whatsapp_token
                ...
                if (status_response.status_code == 200 or status_response.status_code == 201) and json_response_status['accountStatus'] == 'authenticated':
                    if partner_id.country_id.phone_code and partner_id.mobile:
                        ...
                        phone_exists_url = res_user_id.whatsapp_endpoint + '/checkPhone?token=' + res_user_id.whatsapp_token + '&phone=' + str(partner_id.country_id.phone_code) + "" + whatsapp_msg_number_without_code
                ...
                if res_user_id.whatsapp_endpoint and res_user_id.whatsapp_token:
                    ...
                    if (status_response.status_code == 200 or status_response.status_code == 201) and json_response_status[
                        ...
                        if partner_id.country_id.phone_code and partner_id.mobile:
                            ...
                            phone_exists_url = res_user_id.whatsapp_endpoint + '/checkPhone?token=' + res_user_id.whatsapp_token + '&phone=' + str(
